...
var tarteaucitron = {
    ...
    "addService": function (serviceId) {
        ...
        if (tarteaucitron.added[service.key] !== true) {
            ...
            if (tarteaucitron?.lang?.finalite[service.key]) {
                html += '       <span class="tacCurrentFinalite" id="tacCurrentStatus">'+ tarteaucitron.lang.finalite[service.key] +'</span><br/>';
            }
            ...
            if (tarteaucitron.parameters.moreInfoLink == true) {
                ...
                if (service.key === 'maps_noapi') {
                    link = tarteaucitron.lang.links.maps_noapi;
                }
                if (service.key === 'youtube_saclay') {
                    link = tarteaucitron.lang.links.youtube_saclay;
                }
    ...
    "getLanguage": function () {
        ...
        var availableLanguages = 'bg,ca,cn,cs,da,de,et,el,en,es,fi,fr,hu,it,ja,lt,lv,nl,no,oc,pl,pt,ro,ru,se,sk,sv,tr,vi,zh',
            defaultLanguage = 'en';
